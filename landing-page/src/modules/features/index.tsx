import { Calendar, DollarSign, Flame, Sparkles } from "lucide-react";

const features = [
	{
		icon: Sparkles,
		title: "AI Assistant",
		description: "Get helpful, context-aware suggestions while you journal",
		shadowColor: "shadow-indigo-100",
	},
	{
		icon: DollarSign,
		title: "Pricing",
		description: "Simple, affordable plans to unlock advanced AI features",
		shadowColor: "shadow-blue-100",
	},
	{
		icon: Flame,
		title: "Streaks",
		description: "Build momentum with daily streaks and gentle reminders",
		shadowColor: "shadow-emerald-100",
	},
	{
		icon: Calendar,
		title: "Daily Prompts",
		description: "Thoughtful prompts to reflect, plan, and celebrate progress",
